...
maxPracTrials = 50; %25/50 are spatio (50%), just like real exp, should be enough to tell spatio fac
correctFixMinP4 = 20;
...
% tGuessSd = stair*4; %approximate sd
% 
